(function() {
  ...
  jasmineNode.TerminalReporter.prototype = {
    ...
    ANSIColors: {
        pass:    function() { return '\x1B[32m'; }, // Green
        fail:    function() { return '\x1B[31m'; }, // Red
        specTiming:  function()  { return '\x1B[34m'; }, // Blue
        suiteTiming:  function() { return '\x1B[33m'; }, // Yelow
        ignore:  function() { return '\x1B[37m'; }, // Light Gray
        neutral: function() { return '\x1B[0m';  }  // Normal
    },
